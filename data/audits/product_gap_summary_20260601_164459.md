...
Generated: 2026-06-01T16:44:59

## Executive Read

- Products in current master: 980 across 362 companies.
- Company coverage source: product_master.csv derived.
- Queue rows generated: 876; P0/P1 review-first rows: 0.
- Unverified seed rows in queue: 1 (0.1%).
- Products without direct official product/family URL: 15 (1.7%).
- Products without direct A/B spec candidate: 11 (1.3%).
- Regulated products without registration evidence: 259.
...
|---|---:|---|---|---|---|---|
| P3 | 24 | Bayer | Skinoren 施灵乐/思丽安 / Acne & Rosacea | Skincare | master_unverified_seed <br> no_direct_spec_candidate <br> has_review_leads | Review A/B spec candidates and map useful rows to product/family; discard weak C rows. |
| P3 | 22 | Alma Lasers | Alma TED / Trans-Epidermal Drug Delivery | EBD | no_official_indication <br> priority_company | Keep as lower-priority monitoring item. |
...
- Product gap queue: `data\audits\product_gap_queue_20260601_164459.csv`
- Candidate missing product/family rows: `data\audits\candidate_missing_product_lines_20260601_164459.csv`
