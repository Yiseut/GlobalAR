...
- Regulated products without registration evidence: 0.
...
| P3 | 12 | Alma Lasers | Alma PrimeX / Enhanced RF + Ultrasound | EBD | no_reviewed_differentiator <br> priority_company <br> has_review_leads | Keep as lower-priority monitoring item. |
| P3 | 12 | Alma Lasers | BeautiFill / Laser-Assisted Liposuction | EBD | no_reviewed_differentiator <br> priority_company <br> has_review_leads | Keep as lower-priority monitoring item. |

## Files

- Product gap queue: `data\audits\product_gap_queue_20260601_182645.csv`
- Candidate missing product/family rows: `data\audits\candidate_missing_product_lines_20260601_182645.csv`
