  ...
  const topNav = [
    {
      ...
      en: "Injectables",
      children: [
        { href: "./topic.html?segment=injectables&focus=ha-fillers#subtrack-analysis", zh: "HA 填充", en: "HA fillers" },
        { href: "./topic.html?segment=injectables&focus=skin-boosters#subtrack-analysis", zh: "Skin Booster / 中胚层", en: "skin boosters" },
        { href: "./topic.html?segment=injectables&focus=neurotoxin#subtrack-analysis", zh: "肉毒毒素", en: "toxins" },
        { href: "./topic.html?segment=injectables&focus=biostimulators#subtrack-analysis", zh: "生物刺激剂", en: "biostimulators" },
        { href: "./topic.html?segment=injectables&focus=collagen-nucleotides#subtrack-analysis", zh: "胶原 / PN / PDRN", en: "collagen / nucleotides" },
      ],
    },
    {
      id: "topic-ebd",
      ...
      en: "Energy Devices",
      children: [
        { href: "./topic.html?segment=ebd&focus=laser-ipl#subtrack-analysis", zh: "激光 / IPL", en: "laser and light" },
        { href: "./topic.html?segment=ebd&focus=rf#subtrack-analysis", zh: "射频 / RF", en: "radiofrequency" },
        { href: "./topic.html?segment=ebd&focus=hifu-ultrasound#subtrack-analysis", zh: "HIFU / 超声", en: "ultrasound" },
        { href: "./topic.html?segment=ebd&focus=microneedling#subtrack-analysis", zh: "微针 / RF 微针", en: "microneedling" },
        { href: "./topic.html?segment=ebd&focus=body-shaping#subtrack-analysis", zh: "身体塑形 / EMS", en: "body shaping" },
        { href: "./topic.html?segment=ebd&focus=hybrid-energy#subtrack-analysis", zh: "联合能源 / 其他", en: "hybrid energy" },
      ],
    },
    {
      ...
      en: "Regen Bio",
      children: [
        { href: "./topic.html?segment=regenerative&focus=exosome#subtrack-analysis", zh: "外泌体", en: "exosome" },
        { href: "./topic.html?segment=regenerative&focus=prp-prf#subtrack-analysis", zh: "PRP / PRF", en: "autologous blood" },
        { href: "./topic.html?segment=regenerative&focus=stem-cell#subtrack-analysis", zh: "干细胞", en: "stem cell" },
        { href: "./topic.html?segment=regenerative&focus=growth-factor#subtrack-analysis", zh: "生长因子", en: "growth factors" },
      ],
    },
    {
      id: "topic-other",
      ...
      children: [
        ...
        { href: "./topic.html?segment=consumables&focus=threads#subtrack-analysis", zh: "埋线提升", en: "threads" },
